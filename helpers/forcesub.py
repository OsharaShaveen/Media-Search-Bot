    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Dear, You are Banned to use me ?¹ï?\nFeel free to say in our [My Coder](https://t.me/WhiteDevilOp999).",
                parse_mode="markdown",
